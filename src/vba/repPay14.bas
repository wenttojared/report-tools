...
Private Function IsEmployeeHeader(ByVal s As String) As Boolean
...
Private Sub ParseEmployeeHeader(ByVal s As String, ByRef empName As String, ByRef empID As String, ByRef last4 As String)
